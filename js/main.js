...
(function ensureSharedQuickmenu() {
  ...
  const copy = {
    ...
    ja: { nav: "クイックメニュー", phone: "電話相談", phoneAria: "電話相談", booking: "NAVER予約", bookingAria: "NAVER予約", talk: "NAVERトーク", talkAria: "NAVERトーク", blog: "ブログ", instagram: "Instagram", top: "トップ", topAria: "トップ" },
...
(function normalizeLocalizedQuickmenuLabels() {
  ...
  const labels = {
    ...
    ja: { phone: "電話", booking: "NAVER予約", talk: "NAVERトーク", international: "予約", blog: "ブログ", instagram: "Instagram", journal: "ジャーナル", top: "トップ" },
...
if (nav && navMenu && !document.body.classList.contains("error-page")) {
  ...
  const localizedPages = new Set([
    ...
    "dear-gongjindan.html", "be-deer.html", "be-deer-cases.html",
  ]);
...
(function alignLocalizedPageUi() {
  ...
  const copy = {
    en: {
      ...
      directorArticles: "Clinical columns written and reviewed by Director Minji Kim", directorCard: "A translated DEAR clinical column", directorAll: "View translated columns →",
