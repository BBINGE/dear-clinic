(function () {
  ...
  const copy = {
    ko: ['대화 전에 잠깐 확인해주세요', '디숭이는 AI 안내자예요. 진단·처방·예약 확정은 하지 않아요. 이름·전화번호·진료기록과 다른 사람의 정보는 적지 말아주세요. 대화 내용은 안내 품질 개선을 위해 12개월간 보관하고, 동의를 철회하면 삭제해요.', '만 14세 이상이에요', '대화 입력·응답의 개인정보 처리에 동의해요', '입력에 포함될 수 있는 건강정보 처리에 별도로 동의해요', '안내된 국외 이전에 별도로 동의해요', '처리 항목·보관·국외 이전 자세히 보기', '동의하고 대화 시작', '동의하지 않거나 만 14세 미만이라면', '전화로 안내받기', '예약 안내 보기', '대화 종료·동의 철회', '동의 정보를 확인하지 못했어요. 잠시 후 다시 시도해주세요.', '철회 요청을 완료하지 못했어요. 대화는 중단했으며 재시도할 수 있어요.', '대화가 종료됐어요. 이미 전송된 정보의 삭제 문의는 개인정보방침의 연락처로 요청해주세요.', '동의 내역 보기'],
    en: ['Before we chat', 'Disoongi is an AI guide, not a clinician. It cannot diagnose, prescribe or confirm bookings. Do not enter names, contact details, medical records or another person’s information. Conversations are kept for 12 months to improve guidance and deleted if you withdraw consent.', 'I am at least 14 years old', 'I consent to processing personal data in chat inputs and replies', 'I separately consent to processing health information I may enter', 'I separately consent to the described overseas transfers', 'Data, retention and overseas transfer details', 'Agree and start chatting', 'Under 14 or prefer not to agree?', 'Call DEAR', 'Appointment guide', 'End chat and withdraw consent', 'We could not confirm your choices. Please try again.', 'Withdrawal could not be confirmed. Chat has stopped; please retry.', 'Chat ended. For deletion of information already sent, contact the clinic as described in the privacy notice.', 'View consent receipt'],
    ja: ['会話の前にご確認ください', 'ディスンイはAI案内役です。診断・処方・予約確定は行いません。氏名・連絡先・診療記録や他の方の情報は入力しないでください。会話内容は案内の品質改善のため12か月間保管し、同意を撤回すると削除します。', '14歳以上です', '会話の入力・回答に含まれる個人情報の処理に同意します', '入力に含まれる健康情報の処理に別途同意します', '案内された国外移転に別途同意します', '処理項目・保存・国外移転の詳細', '同意して会話を開始', '14歳未満、または同意しない場合', '電話で相談', '予約案内', '会話終了・同意撤回', '同意を確認できませんでした。再度お試しください。', '撤回を確認できませんでした。会話は停止しています。再試行してください。', '会話を終了しました。送信済み情報の削除は方針に記載の窓口へご相談ください。', '同意の記録を見る'],
    zh: ['开始对话前请确认', '迪崇是AI向导，不进行诊断、处方或确认预约。请勿输入姓名、联系方式、诊疗记录或他人的信息。对话内容为改进引导质量保存12个月，撤回同意后删除。', '我已满14周岁', '我同意处理对话输入及回复中的个人信息', '我另行同意处理可能输入的健康信息', '我另行同意所说明的境外传输', '处理项目、保留及境外传输详情', '同意并开始对话', '未满14周岁或不愿同意？', '致电诊所', '预约指南', '结束对话并撤回同意', '无法确认同意，请稍后重试。', '未能确认撤回。对话已停止，请重试。', '对话已结束。如需删除已发送的信息，请通过隐私政策中的联系方式提出。', '查看同意记录']
  };
  window.createDearConsent = function ({ endpoint, language, getAccessCode, onStop, onReady }) {
    const t = copy[language] || copy.ko;
    const note = {
      ko: '저는 AI로 진료·예약 방법을 안내해요. 진단·처방은 원장님 진료로, 예약 확정은 예약 채널에서 진행돼요. 대화에는 이름·연락처·진료기록이나 다른 사람의 정보는 빼고 적어주세요. 대화 내용은 안내 품질 개선을 위해 12개월간 보관하고, 동의를 철회하면 삭제해요.',
      en: 'I’m an AI guide to care and booking. Diagnosis and prescriptions require a clinician; bookings are confirmed through the booking channel. Leave names, contact details, medical records and other people’s information out of the chat. Conversations are kept for 12 months to improve guidance and deleted if you withdraw consent.',
      ja: '私は診療や予約方法をご案内するAIです。診断・処方は医師の診察で、予約確定は予約窓口で行います。氏名・連絡先・診療記録や他の方の情報は入力せずにお話しください。会話内容は案内の品質改善のため12か月間保管し、同意を撤回すると削除します。',
      zh: '我是介绍诊疗和预约方式的AI。诊断和处方由医生面诊后决定，预约由预约渠道确认。聊天时请省略姓名、联系方式、诊疗记录及他人的信息。对话内容为改进引导质量保存12个月，撤回同意后删除。'
    }[language] || t[1];
    const welcome = {
