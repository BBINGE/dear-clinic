...
- **2026-09-06 인수인계:** 디숭이는 일반 공개 중이며 개인정보처리방침 정리까지 배포했다. 최신 상태·합의한 말투/캐릭터/동의 UX·비용 제한·파일 지도는 [HANDOFF.md의 현재 운영 요약](HANDOFF.md)부터 확인한다. 아래 과거 복구 태그를 최신 운영본으로 오인하지 않는다.
