...
const consent = {version:'20260917-chatlog-1',age14:true,personal:true,health:true,overseas:true,acceptedAt:Date.now()};
...
const persistentConsent={...consent,version:'20260917-chatlog-1'};
