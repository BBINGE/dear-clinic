...
import { CONTACT_DOCK } from "./refresh-column-cards.mjs";
...
${previewMeta}  <title>${escapeHtml(content.title)} | 디어한의원</title>
  ...
  <link rel="stylesheet" href="../css/style.css?v=20260922-1">
  <link rel="stylesheet" href="../css/dear-reads.css?v=20260922-4">
  <link rel="stylesheet" href="../css/column-contact.css?v=20260922-8">
...
<main class="column-article"><article>
  ...
  <div class="column-article__layout">
    ...
    <div class="column-article__content">
      ...
      ${faq.html}
      ${sources}
      <!-- CONTACT_DOCK:START -->${CONTACT_DOCK}<!-- CONTACT_DOCK:END -->
...
<script src="../js/main.js?v=20260922-3"></script>
