...
- 한국어 메인 히어로는 기존 외국인 모델 제품 영상을 화면에서 제외하고, 실제 디어한의원 대기 공간·체성분 결과지 출력·한약 조제실 사진 3장을 12초 동안 천천히 교차하는 구조로 교체했다. 카피는 굵은 `Always "DEAR" You`와 얇은 `오늘도 소중한 당신의 디어한의원입니다.` 두 줄로 고정하며, 기존 WebM·MP4·포스터 자산은 삭제하지 않고 보관한다.
