...
- 메인페이지의 BE DEER CTA와 공진단 소개 사이에 `DEAR STANDARD` 섹션을 추가했다. LISTEN–MEASURE–DESIGN–FOLLOW–RECORD의 5단계로 디어의 상담·상태 확인·진료 설계·경과 관리·기록 원칙을 표현하며, 기존 메인 섹션은 변경하지 않았다.
