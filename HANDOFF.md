...
- `care.html`은 기존 다섯 가지 Care 탭과 문구를 유지하면서 사진 중심 구조로 개편했다. 실제 원장 사진과 공간 사진을 참고한 생성형 문진·상태 평가·치료 준비 이미지 3장과 실제 치료실 사진을 사용하며, 생성 이미지 고지 문구를 함께 표시한다. 밝은 Care 첫 화면에서 보이지 않던 상단 내비게이션은 Care 페이지에 한해 초록색으로 보정했다.
