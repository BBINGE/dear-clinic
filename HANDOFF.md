...
- 날씨 UI는 작은 원형 렌즈가 아니라 카드 전체가 실제 서초동 풍경을 보여주는 와이드 렌즈다. 풍경 위에는 좌측이 더 짙은 검정 유리막을 겹쳐 흰색 날짜·상태·안내 문구의 가독성을 확보하고, 상태별 이모지는 맑음 회전, 구름 왕복, 비·눈 낙하, 바람 횡이동, 천둥번개 순간 발광 모션을 사용한다.
