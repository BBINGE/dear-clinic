...
- BE DEER의 `WHY I MADE BE DEER` 본문은 원장 개인의 말투가 느껴지도록 운동에 대한 공부와 먹는 즐거움, 지속 가능한 다이어트를 잇는 확정 카피로 교체했다. 여섯 관찰 항목의 픽토그램은 제거하고, 낮은 불투명도의 큰 번호를 카드 배경에 배치해 항목의 순서와 편집 디자인의 인상을 강조했다. 모바일에서는 번호 크기와 본문 간격을 별도로 줄인다.
