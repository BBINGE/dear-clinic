...
- `care.html`은 기존 다섯 가지 Care 탭과 문구를 유지하면서 사진 중심 구조로 개편했다. 실제 원장 사진과 공간 사진을 참고한 문진·상태 평가·치료 준비 이미지 3장과 실제 치료실 사진을 사용한다. 진료 장면과 다섯 Care 사이에는 같은 진료 과정에서 오늘의 상태에 따라 살피는 초점이 달라진다는 연결 문장을 두었다. PC 진료 장면은 넓은 대표 사진 1장과 하단 보조 사진 2장의 기존 흐름을 유지하면서 모든 사진을 3:1 와이드 크롭으로 낮췄고, 모바일은 16:9 비율을 사용한다. 밝은 첫 화면의 상단 내비게이션은 초록색으로 보정했다.
